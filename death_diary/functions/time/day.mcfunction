...
#12月
execute @p[scores={day=32..,month=12}] ~~~ scoreboard players add m month 1
...
#提示
titleraw @a[scores={hour=0..9,min=0..9}] actionbar {"rawtext":[{"text":"§e§l时间:§b"},{"score":{"name":"y","objective":"year"}},{"text":"§e年§b"},{"score":{"name":"m","objective":"month"}},{"text":"§e月§b"},{"score":{"name":"d","objective":"day"}},{"text":"§e日§b0"},{"score":{"name":"h","objective":"hour"}},{"text":"§e：§b0"},{"score":{"name":"m","objective":"min"}}]}
titleraw @a[scores={hour=0..9,min=!0..9}] actionbar {"rawtext":[{"text":"§e§l时间:§b"},{"score":{"name":"y","objective":"year"}},{"text":"§e年§b"},{"score":{"name":"m","objective":"month"}},{"text":"§e月§b"},{"score":{"name":"d","objective":"day"}},{"text":"§e日§b0"},{"score":{"name":"h","objective":"hour"}},{"text":"§e：§b"},{"score":{"name":"m","objective":"min"}}]}
titleraw @a[scores={hour=!0..9,min=0..9}] actionbar {"rawtext":[{"text":"§e§l时间:§b"},{"score":{"name":"y","objective":"year"}},{"text":"§e年§b"},{"score":{"name":"m","objective":"month"}},{"text":"§e月§b"},{"score":{"name":"d","objective":"day"}},{"text":"§e日§b"},{"score":{"name":"h","objective":"hour"}},{"text":"§e：§b0"},{"score":{"name":"m","objective":"min"}}]}
titleraw @a[scores={hour=!0..9,min=!0..9}] actionbar {"rawtext":[{"text":"§e§l时间:§b"},{"score":{"name":"y","objective":"year"}},{"text":"§e年§b"},{"score":{"name":"m","objective":"month"}},{"text":"§e月§b"},{"score":{"name":"d","objective":"day"}},{"text":"§e日§b"},{"score":{"name":"h","objective":"hour"}},{"text":"§e：§b"},{"score":{"name":"m","objective":"min"}}]}