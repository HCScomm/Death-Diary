...
scoreboard players random @a[scores={temperatureTime=2010..}] temperature1 1 10000
scoreboard players set @a[scores={temperatureTime=2010..}] temperatureTime 0

#温度调节器(水)
scoreboard players add @a temperature3 0
scoreboard players random @a[tag=spring] temperature3 1 2
scoreboard players random @a[tag=summer] temperature3 1 1
scoreboard players random @a[tag=autumn] temperature3 1 2
scoreboard players random @a[tag=winter] temperature3 2 3
#温度调节器(空气)
scoreboard players add @a temperature4 0
scoreboard players random @a[tag=spring] temperature4 1 2
scoreboard players set @a[tag=summer] temperature4 1 
scoreboard players random @a[tag=autumn] temperature4 1 2
scoreboard players random @a[tag=winter] temperature4 1 3
#上升
...
#如果碰到水
#春季(46.7%)
execute @e[type=player,scores={temperatureTime=2000..,temperature1=1..4670},tag=spring] ~~~ detect ~~~  water -1  scoreboard players operation @s temperature2 -= @s temperature3
#夏季(20.25%)
execute @e[type=player,scores={temperatureTime=2000..,temperature1=1..2025},tag=summer] ~~~ detect ~~~  water -1  scoreboard players operation @s temperature2 -= @s temperature3
#秋季(32.5%)
execute @e[type=player,scores={temperatureTime=2000..,temperature1=1..3250},tag=autumn] ~~~ detect ~~~  water -1  scoreboard players operation @s temperature2 -= @s temperature3
#冬季(100%)
execute @e[type=player,scores={temperatureTime=2000..},tag=winter] ~~~ detect ~~~  water -1  scoreboard players operation @s temperature2 -= @s temperature3

#因季节而变化(体温上升)
#春季(13.5%)
execute @e[type=player,scores={temperatureTime=2000..,temperature1=1..1350},tag=spring] ~~~ scoreboard players operation @s temperature2 += @s temperature5
#夏季(90.5%)
execute @e[type=player,scores={temperatureTime=2000..,temperature1=1..9050},tag=summer] ~~~ scoreboard players operation @s temperature2 += @s temperature5
#秋季(18.5%)
execute @e[type=player,scores={temperatureTime=2000..,temperature1=1..1850},tag=autumn] ~~~ scoreboard players operation @s temperature2 += @s temperature5
#冬季(0.5%)
execute @e[type=player,scores={temperatureTime=2000..,temperature1=1..50},tag=winter] ~~~ scoreboard players operation @s temperature2 += @s temperature5

#因季节而变化
#春季(12.5%)
execute @e[type=player,scores={temperatureTime=2000..,temperature1=1..1250},tag=spring] ~~~ scoreboard players operation @s temperature2 -= @s temperature4
#夏季(0.05%)
execute @e[type=player,scores={temperatureTime=2000..,temperature1=1..5},tag=summer] ~~~ scoreboard players operation @s temperature2 -= @s temperature4
#秋季(10.5%)
execute @e[type=player,scores={temperatureTime=2000..,temperature1=1..1050},tag=autumn] ~~~ scoreboard players operation @s temperature2 -= @s temperature4
#冬季(80.5%)
execute @e[type=player,scores={temperatureTime=2000..,temperature1=1..8050},tag=winter] ~~~ scoreboard players operation @s temperature2 -= @s temperature4