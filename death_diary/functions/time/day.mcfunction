...
#时间更替
#秒
execute @p[scores={second=83..}] ~~~ scoreboard players add m min 1
execute @p[scores={second=83..}] ~~~ time add 17
execute @p[scores={second=83..}] ~~~ scoreboard players set s second 0
