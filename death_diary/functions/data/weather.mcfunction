...
execute @p[tag=spring,scores={weather2=2501..},tag=waitRain] ~~~ function data/end
...
execute @p[tag=summer,scores={weather2=3101..},tag=waitRain] ~~~ function data/end
...
execute @p[tag=autumn,scores={weather2=8001..},tag=waitRain] ~~~ function data/end
...
execute @p[tag=winter,scores={weather2=6501..},tag=waitRain] ~~~ function data/end
